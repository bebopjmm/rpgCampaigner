...
public class ComplexMappingIntegrationTests {
    ...
    public void thatItemCustomMappingWorks() throws Exception {
        assertTableExists(manager, "SETTING_COMPLEXES");

        assertTableHasColumn(manager, "SETTING_COMPLEXES", "COMPLEX_ID");
        assertTableHasColumn(manager, "SETTING_COMPLEXES", "NAME");
        assertTableHasColumn(manager, "SETTING_COMPLEXES", "CAMPAIGNSLUG");
    }
